 ...
 */
public class FragmentLevelPage1 extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.level_page_one_fragment, container, false);
        ...
        int levels = sharedPreferences.getInt("LEVEL_COUNT", 0);
            ...
            if (levels == 0) {
                levelView = (TextView) v.findViewById(R.id.level1);
